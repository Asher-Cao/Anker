...
(cl:in-package anker_ekf_pro-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <AnkerDataType>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnkerDataType)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name anker_ekf_pro-msg:<AnkerDataType> is deprecated: use anker_ekf_pro-msg:AnkerDataType instead.")))

(cl:ensure-generic-function 'time_s-val :lambda-list '(m))
(cl:defmethod time_s-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:time_s-val is deprecated.  Use anker_ekf_pro-msg:time_s instead.")
  (time_s m))

(cl:ensure-generic-function 'gx-val :lambda-list '(m))
(cl:defmethod gx-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:gx-val is deprecated.  Use anker_ekf_pro-msg:gx instead.")
  (gx m))

(cl:ensure-generic-function 'gy-val :lambda-list '(m))
(cl:defmethod gy-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:gy-val is deprecated.  Use anker_ekf_pro-msg:gy instead.")
  (gy m))

(cl:ensure-generic-function 'gz-val :lambda-list '(m))
(cl:defmethod gz-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:gz-val is deprecated.  Use anker_ekf_pro-msg:gz instead.")
  (gz m))

(cl:ensure-generic-function 'ax-val :lambda-list '(m))
(cl:defmethod ax-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:ax-val is deprecated.  Use anker_ekf_pro-msg:ax instead.")
  (ax m))

(cl:ensure-generic-function 'ay-val :lambda-list '(m))
(cl:defmethod ay-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:ay-val is deprecated.  Use anker_ekf_pro-msg:ay instead.")
  (ay m))

(cl:ensure-generic-function 'az-val :lambda-list '(m))
(cl:defmethod az-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:az-val is deprecated.  Use anker_ekf_pro-msg:az instead.")
  (az m))

(cl:ensure-generic-function 'odo_right_pos-val :lambda-list '(m))
(cl:defmethod odo_right_pos-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:odo_right_pos-val is deprecated.  Use anker_ekf_pro-msg:odo_right_pos instead.")
  (odo_right_pos m))

(cl:ensure-generic-function 'odo_left_pos-val :lambda-list '(m))
(cl:defmethod odo_left_pos-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:odo_left_pos-val is deprecated.  Use anker_ekf_pro-msg:odo_left_pos instead.")
  (odo_left_pos m))

(cl:ensure-generic-function 'odo_right_vel-val :lambda-list '(m))
(cl:defmethod odo_right_vel-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:odo_right_vel-val is deprecated.  Use anker_ekf_pro-msg:odo_right_vel instead.")
  (odo_right_vel m))

(cl:ensure-generic-function 'odo_left_vel-val :lambda-list '(m))
(cl:defmethod odo_left_vel-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:odo_left_vel-val is deprecated.  Use anker_ekf_pro-msg:odo_left_vel instead.")
  (odo_left_vel m))

(cl:ensure-generic-function 'opt_pos_x-val :lambda-list '(m))
(cl:defmethod opt_pos_x-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:opt_pos_x-val is deprecated.  Use anker_ekf_pro-msg:opt_pos_x instead.")
  (opt_pos_x m))

(cl:ensure-generic-function 'opt_pos_y-val :lambda-list '(m))
(cl:defmethod opt_pos_y-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:opt_pos_y-val is deprecated.  Use anker_ekf_pro-msg:opt_pos_y instead.")
  (opt_pos_y m))

(cl:ensure-generic-function 'opt_quality-val :lambda-list '(m))
(cl:defmethod opt_quality-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:opt_quality-val is deprecated.  Use anker_ekf_pro-msg:opt_quality instead.")
  (opt_quality m))

(cl:ensure-generic-function 'wall_distance_right-val :lambda-list '(m))
(cl:defmethod wall_distance_right-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:wall_distance_right-val is deprecated.  Use anker_ekf_pro-msg:wall_distance_right instead.")
...
(cl:defmethod wall_distance_left-val ((m <AnkerDataType>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anker_ekf_pro-msg:wall_distance_left-val is deprecated.  Use anker_ekf_pro-msg:wall_distance_left instead.")
