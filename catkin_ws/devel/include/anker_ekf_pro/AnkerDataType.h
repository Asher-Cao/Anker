// Generated by gencpp from file anker_ekf_pro/AnkerDataType.msg
// DO NOT EDIT!


#ifndef ANKER_EKF_PRO_MESSAGE_ANKERDATATYPE_H
#define ANKER_EKF_PRO_MESSAGE_ANKERDATATYPE_H
...
struct AnkerDataType_
{
  ...
  typedef boost::shared_ptr< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> const> ConstPtr;

}; // struct AnkerDataType_

typedef ::anker_ekf_pro::AnkerDataType_<std::allocator<void> > AnkerDataType;

typedef boost::shared_ptr< ::anker_ekf_pro::AnkerDataType > AnkerDataTypePtr;
typedef boost::shared_ptr< ::anker_ekf_pro::AnkerDataType const> AnkerDataTypeConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'anker_ekf_pro': ['/home/kdq/Workspace/Anker/catkin_ws/src/AnkerEKF/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::anker_ekf_pro::AnkerDataType_<ContainerAllocator> >
{
...
#endif // ANKER_EKF_PRO_MESSAGE_ANKERDATATYPE_H
