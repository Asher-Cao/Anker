function [pos_from_imu,pos_from_odometry,scalar] = motion_propagate(imu,odometry)
...
for i=2:len
   ...
   pos_from_imu(i,3) = pos_from_imu(i-1,3) + (imu(i,7)-gz_bias)*gz_gain*pi/180*delta_time;
